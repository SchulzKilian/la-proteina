#!/bin/bash
# N=24 extension of E077 (curric-ON probe) on the K=40+curric+self ckpt step 1133.
# Same ckpt, same seed=5 (from inference_base.yaml), nsteps=400.
# Adds 18 new samples per L on top of E077's 6 (paired within seed=5 batch 0).
# ~40-50 min on 1× L4.
...
CFG=inference_sparse_K40_curriculum_self_step1133_n24_nfe400
