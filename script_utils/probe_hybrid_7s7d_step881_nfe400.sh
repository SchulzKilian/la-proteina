...
# layer-hybrid sparse/dense model (ca_only_hybrid_7s7d), global_step 881.
#
...
#
# E127: designability probe — does ca_only_hybrid_7s7d step 881 clear the
...
CFG=inference_hybrid_7s7d_step881_n6_nfe400
GPU=${CUDA_VISIBLE_DEVICES:-4}
LOGBASE=/home/ks2218/la-proteina/nohup_probe_hybrid_7s7d_step881_nfe400

echo "[$(date)] [GPU $GPU] === E127 probe start: $CFG ==="
echo "[$(date)] [GPU $GPU] ckpt: /home/ks2218/la-proteina/ca_only_hybrid_7s7d_step881.ckpt -> best_val_00000008_000000000881.ckpt"
echo "[$(date)] [GPU $GPU] model: ca_only_hybrid_7s7d (7 sparse + 7 dense layers, K=40, step 881)"

# Pre-flight: remove stale CSV and PDB dir to ensure fresh run
CSV=/home/ks2218/la-proteina/inference/results_${CFG}_0.csv
GENDIR=/home/ks2218/la-proteina/inference/laproteina_hybrid_7s7d_step881_n6_nfe400
...
echo "[$(date)] [GPU $GPU] === E127 probe complete ==="
if [ -f "$CSV" ]; then
    echo "--- Results summary ---"
    $PYTHON_EXEC - <<'PYEOF'
import pandas as pd
csv = "/home/ks2218/la-proteina/inference/results_inference_hybrid_7s7d_step881_n6_nfe400_0.csv"
df = pd.read_csv(csv)
