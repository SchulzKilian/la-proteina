#!/bin/bash
# Designability probe for the K=40 + curriculum + self-inclusion variant
# (`ca_only_sparse_K40_curriculum_self`) — K=40 cousin of §11 (K=64).
#
# Targets the repo-root symlink `sparse_K40_curriculum_self_step1133.ckpt`
# which points at `best_val_00000011_000000001133.ckpt` (epoch 11, step 1133).
#
# N=6 × L∈{50, 100, 200} × nsteps=400. ~13-15 min on 1× L4.
# Inference config: configs/inference_sparse_K40_curriculum_self_step1133_n6_nfe400.yaml.
...
CFG=inference_sparse_K40_curriculum_self_step1133_n6_nfe400
