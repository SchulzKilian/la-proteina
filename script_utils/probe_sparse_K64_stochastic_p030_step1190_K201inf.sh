...
# with INFERENCE-TIME K=201 (≈ dense for all evaluated lengths L≤200).
#
# Companion probe to E080 (same ckpt, canonical K=64 inference).
# Tests whether the 30% K=full training passes generalise to dense inference.
# K=201 is applied via generate.py's K-bump override mechanism
# (n_seq_neighbors_override=100, n_spatial_neighbors_override=1,
#  n_random_neighbors_override=0) post-load. See inference YAML for details.
#
...
CFG=inference_sparse_K64_stochastic_p030_step1190_K201inf_n6_nfe400
