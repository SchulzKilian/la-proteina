...
| [E079](#e079--n24-extension-of-e078-curriculum-off-inference-on-k40curricself-ckpt-step-1133-2026-05-23) | 2026-05-23 | finished | N=24 extension of [E078](#e078--curriculum-off-inference-probe-of-the-same-k40-curriculum-self-ckpt-step-1133-2026-05-23) on the curric-OFF arm of the K=40+curric+self ckpt step 1133. Same ckpt, same seed=5, same nsteps=400, same `curriculum_neighbors: false`; only `nsamples=24` instead of 6 (adds 18 more samples per L). Curric-ON sibling N=24 was launched in parallel and killed at user request — only the curric-OFF arm has converged-N data. | **Pooled 11/72 (15.3 %); L=50 10/24 (42 %, best 0.73 Å), L=100 1/24 (4 %, best 1.66), L=200 0/24 (0 %, best 8.31).** Softens E078's 83 % L=50 headline substantially — the 5/6 small-N draw sits inside the new [22, 63] % Wilson interval. **Best L=50 single-protein scRMSD = 0.73 Å is the best of any K=40-class arm on record.** Production-relevant verdict update: the K=40+curric+self ckpt with curric-OFF inference is at-or-below plain K=40 ([E019](#e019--full-n30-fixed-mpnn-re-eval-of-e014s-four-arms--5th-paramgroups-arm-2026-04-29) N=30 = 23 %; [E044](#e044--inference-only-neighbor-list-curriculum-on-plain-sparse_k40-step-1259-2026-05-07) N=6 = 28 %), not above it. The curric-OFF > curric-ON direction from [E078](#e078--curriculum-off-inference-probe-of-the-same-k40-curriculum-self-ckpt-step-1133-2026-05-23) survives qualitatively (15 % > 11 %) but the magnitude is much smaller than E078 framed. E078's "asymmetric generalization beats plain K=40" narrative is **withdrawn**; the most defensible claim on this ckpt is now "curric-ON is unambiguously worse than curric-OFF, but curric-OFF only matches plain K=40 at L=50". Not paired-by-noise with E078 (RNG state shifts with nsamples). |
| [E078](#e078--curriculum-off-inference-probe-of-the-same-k40-curriculum-self-ckpt-step-1133-2026-05-23) | 2026-05-23 | finished — **L=50 headline softened by [E079](#e079--n24-extension-of-e078-curriculum-off-inference-on-k40curricself-ckpt-step-1133-2026-05-23)** | Sibling of [E077](#e077--first-designability-probe-of-the-k40--curriculum--self-cousin-of-11-ca_only_sparse_k40_curriculum_self-step-1133-2026-05-23) with the trained-in curriculum FORCED OFF at inference (static K=40 (8,8,16) at all t via `generation.args.curriculum_neighbors: false`). Same ckpt, same seed=5, same nsteps=400 — only the inference-time neighbor schedule changes. Tests whether E077's regression came from architecture, training-time schedule, or inference-time schedule. | **Pooled 6/18 (33 %); +4 designable swing at L=50 vs E077 (5/6 vs 1/6, both at best 0.91 Å), L=100 / L=200 unchanged.** Beats plain K=40 baseline ([E044](#e044--inference-only-neighbor-list-curriculum-on-plain-sparse_k40-step-1259-2026-05-07), 5/18 at step 1259, +126 step-deficit) at L=50 (5/6 vs 3/6, +2 designable) AND beats §11 K=64 ([E049](#e049--first-inference-probe-of-the-k64--curriculum-trained-ckpt-ca_only_sparse_k64_curriculum_self-ep9-step944-2026-05-08), 4/18) on the same axis. **Sharpens E077's read**: the K=40+curriculum+self **architecture** is not dead — the trained weights actually outperform every K=40-class cousin on record at L=50; what is dead is the **curriculum-at-inference path** on this ckpt. The model learned representations that handle the never-seen-at-low-t plain (8,8,16) input *better* than its training-distribution (20,0,0) low-t sequential-only input. Asymmetric generalization. Withdraws E077's dead-arm-candidate framing on the architecture; redirects the verdict to the curriculum-inference-path. **Note (2026-05-23):** the "beats plain K=40 at L=50" headline is **withdrawn** by [E079](#e079--n24-extension-of-e078-curriculum-off-inference-on-k40curricself-ckpt-step-1133-2026-05-23)'s N=24 read; the 5/6 was a small-N upper draw. |
| [E077](#e077--first-designability-probe-of-the-k40--curriculum--self-cousin-of-11-ca_only_sparse_k40_curriculum_self-step-1133-2026-05-23) | 2026-05-23 | finished — **architecture verdict superseded by [E078](#e078--curriculum-off-inference-probe-of-the-same-k40-curriculum-self-ckpt-step-1133-2026-05-23)** | First N=6 × L∈{50,100,200} × nsteps=400 canonical designability probe of the **K=40 cousin of §11**: `ca_only_sparse_K40_curriculum_self` at ep=11 step=1133. Same three architectural axes as §11 (K + curriculum + self-inclusion) but K=40 instead of K=64 — directly tests whether the curriculum mechanism scales down or whether §11's L=50 success required the K=64 budget. Required a ~10-line plumbing patch to main-branch inference code (`proteinfoundation/proteina.py` + `local_latents_transformer.py`) to forward `curriculum_mid_t_split` / `curriculum_high_t_split` from `cfg_exp.training` and relax the K==64 assertion to a per-bucket K-consistency check; the K=40 training fork uses splits `(20,0,0)/(14,4,8)/(8,8,16)` all summing to K=40. | **Pooled 2/18 (11.1 %); worse than §11 K=64 step-944 (4/18, [E049](#e049--first-inference-probe-of-the-k64--curriculum-trained-ckpt-ca_only_sparse_k64_curriculum_self-ep9-step944-2026-05-08)) and below the plain K=40 baseline at step 1259 (5/18, [E044](#e044--inference-only-neighbor-list-curriculum-on-plain-sparse_k40-step-1259-2026-05-07)).** Per-L: L=50 1/6 (best 1.08, median 3.40) vs §11 step-944 3/6 (best 0.91) — **−2 designable at L=50 despite +189 training steps**; L=100 1/6 (best 1.66) matches §11 step-944's 1/6 (best 1.22); L=200 0/6 dead (best 8.12) matches both cousins. The §11→K=40 ablation **loses the L=50 win** that was §11's headline result. **Reframed by [E078](#e078--curriculum-off-inference-probe-of-the-same-k40-curriculum-self-ckpt-step-1133-2026-05-23) (same day, same ckpt, curric-OFF inference)**: the regression here was caused by running curriculum AT INFERENCE on a ckpt whose learned representation is better-served by the static (8,8,16) path — not by the K=40 architecture or training. E077's original framing ("K=64 budget was load-bearing for §11's L=50 win") is *not* supported by E078 — K=40 at L=50 matches §11 (both 5/6 once inference path is correct). |
...
## E062 — Hybrid grad-routing inference-time test of the per-query routing prior on §11 sparse step 1800 (frozen_t05 + every_M=50, 2026-05-13)

**Status:** finished — directional negative under both K-set update strategies; supersedes any optimistic reading of [E061](#e061--per-query-vjp-gradient-saliency-inverts-e060-2026-05-13) / Finding 12 that would have justified inference-only K-set swap.

**Why ran.** [E061](#e061--per-query-vjp-gradient-saliency-inverts-e060-2026-05-13) / Finding 12 surfaced two factually-supported claims: (a) dense's attention pattern reflects loss-importance per-query at some (layer, head) for every query (mean-of-max Jaccard 0.833); (b) per-query gradient saliency is itself a sharp, t-stable importance signal (mass_top_16 = 0.71, t-Jaccard = 0.66). The constructive proposal from F12 was *per-query routing distillation* — train a sparse student to consume the loss-aligned K-set. **Before committing to a training experiment, the cheaper inference-time test is: does swapping §11 sparse's content-free K-set (seq + spatial-1/d³ + random) for the gradient-derived per-query K-set at inference time, without retraining, move the needle?** F12's narrow claim is "the routing prior is per-query and exists in dense"; this entry tests whether sparse's *existing* trained weights can use that prior at sampling time, or whether the weights themselves need to be retrained to absorb the routing prior.

**Configs.**
- Driver script: `script_utils/hybrid_grad_routing_inference.py` (authored upstream commit family `79517a4`; 4 bug-fix patches applied locally today — listed below). Eval script: `script_utils/eval_hybrid_grad_routing.py` (new, this entry). Both at HEAD with the post-fix commits.
- Sparse ckpt (§11): `/home/ks2218/la-proteina/sparse_K64_curriculum_self_step1800.ckpt` (run `ca_only_sparse_K64_curriculum_self`, ep 17, opt step 1800; the most-converged §11 K=64-curriculum-self ckpt available locally per [feedback_no_rsync_use_local_ckpts.md](../.claude/projects/-home-ks2218-la-proteina/memory/feedback_no_rsync_use_local_ckpts.md)). The originally-specified step-1385 ckpt (`rmuumq8v` val 4.19) is not on disk; step 1800 is its closest local sibling. N=3 paired probe of step 1800 in [E051](#e051--n3-quick-designability-probe-of-ca_only_sparse_k64_curriculum_self-at-step-1800-2026-05-10) was 2/1/0 = 3/9.
- Dense ckpt (gradient teacher): `/home/ks2218/la-proteina/best_val_00000026_000000002646.ckpt` (`test_ca_only_diffusion/1776805213` step 2646 — the canonical [E019](#e019--full-n30-fixed-mpnn-re-eval-of-e014-five-arms-2026-04-29) anchor at 76 % pooled designability). Dense produces velocities only for the gradient-saliency computation — never enters the integrator.
- Hardware: 1× L4 (`gxp-l4-0` GPU 0), `nohup`, sequential gen → eval.
- Strategy 1 (frozen_t05): single saliency compute per protein at anchor t=0.5, K-set frozen for all 400 ODE steps. Output label `grad_routing_smoke_n3`. Sampling wall total: ~4.5 min (gen for 9 baseline + 9 hybrid samples); eval wall: ~12 min (ProteinMPNN + ESMFold per PDB).
- Strategy 2 (every_M=50): K-set refreshed every 50 ODE steps (8 refreshes per trajectory) with **consistent (x_t, t) at each refresh** — anchor mismatch fix. Output label `grad_routing_every_M50_n3`. Sampling wall: ~6 min total; eval wall: ~10 min.
- N=3 per L ∈ {50, 100, 200}, seed = `args.seed (=5) + prot_idx*1000 + L_target` so the same (L, prot_idx) seed is reused for both baseline (sparse-default-K) and hybrid (grad-K) arms — paired-by-noise within each strategy. nsteps = 400 (CLAUDE.md HARD RULE; inherited from the script's default).
- **Bug-fix patches applied locally to `hybrid_grad_routing_inference.py` (run did not work as-shipped):**
  1. `run_sampling_one` originally called `fm.process_batch(batch)` which expects `batch["x_1"]` (training-time only); rewrote to use `predict_for_sampling` + the inference-base `sampling_model_args` dict the way `proteina.py:predict_step` does. ~20 lines.
  2. `full_simulation` squeezes any `size(0)==1` tensor in the batch (line 626-632 of `product_space_flow_matcher.py`), which then trips `assert mask.shape == (nsamples, n)` for B=1 inputs. Pad to B=2 internally in `run_sampling_one` (duplicate row 0), select `final[0]` on return. Same per-call seed preserves paired-noise semantics. ~5 lines.
  3. After patch (2), `compute_gradient_K_set` started seeing B=2 and asserted `B == 1`. Slice down to row 0 for the per-query backward, expand `neighbor_idx`/`slot_valid` back to B_in afterward. ~10 lines.
  4. Sparse ckpt's `cfg_exp.opt.compile_nn=True` makes `proteina.py:147` wrap `self.nn` with `torch.compile`. Dynamo cannot trace the patched `_build_neighbor_idx` (raises `unhashable type: non-nested SymInt` on `einops.rearrange`). Unwrap with `sparse_model.nn = sparse_model.nn._orig_mod` immediately after the ckpt load; same for dense. Lose torch.compile throughput, gain correctness for the patched path. ~6 lines.
- **Bug-fix patch applied to the eval helper:** `script_utils/eval_hybrid_grad_routing.py` initially passed `keep_outputs=False` to `scRMSD`; `run_esmfold` then deletes the entire tmp dir 2 levels up from each `esm_*.pdb_esm_mpnn` (folding_models.py:159) BEFORE `scRMSD` reads them back, causing `FileNotFoundError`. Switched to `keep_outputs=True` and absolute paths. The canonical inference YAML for E019 / E055 / E056 etc. uses `keep_folding_outputs: True` (see `configs/generation/uncond_codes_ca_only.yaml`).

**Results — Strategy 1 (frozen_t05): per-(arm, L) and paired Δ per (L, sample_idx).**

| arm | L | designable (<2 Å) | best Å | median Å | mean Å |
|---|---|---|---|---|---|
| baseline | 50  | 1/3 | **1.08** | 2.13  | 2.87  |
| baseline | 100 | 0/3 | 2.93     | 7.25  | 6.33  |
| baseline | 200 | 0/3 | 12.91    | 13.89 | 13.75 |
| hybrid   | 50  | 1/3 | 1.64     | 2.19  | 3.96  |
| hybrid   | 100 | 0/3 | 5.82     | 9.62  | 9.46  |
| hybrid   | 200 | 0/3 | 15.59    | 16.50 | 16.22 |
| **pooled baseline** | | **1/9 (11.1 %)** | 1.08 | 7.25 | — |
| **pooled hybrid**   | | **1/9 (11.1 %)** | 1.64 | 9.62 | — |

Paired Δ (hybrid − baseline) per (L, s):

| L | s | baseline | hybrid | Δ | winner |
|---|---|---|---|---|---|
| 50 | 0 | 2.126 | 8.039 | **+5.913** | baseline |
| 50 | 1 | 5.408 | 2.193 | −3.215 | hybrid (neither des.) |
| 50 | 2 | **1.078** ✓ | 1.641 ✓ | +0.563 | baseline (both des.) |
| 100 | 0 | 2.926 | 9.624 | **+6.698** | baseline |
| 100 | 1 | 8.811 | 12.925 | +4.113 | baseline |
| 100 | 2 | 7.250 | 5.821 | −1.429 | hybrid (both dead) |
| 200 | 0 | 13.890 | 16.583 | +2.692 | baseline |
| 200 | 1 | 14.440 | 16.501 | +2.060 | baseline |
| 200 | 2 | 12.914 | 15.587 | +2.673 | baseline |
| **net** | | | | **mean Δ +2.230, median Δ +2.673** | **baseline 7 / hybrid 2 / ties 0** |

**Results — Strategy 2 (every_M=50, anchor-mismatch fix).**

| arm | L | designable (<2 Å) | best Å | median Å | mean Å |
|---|---|---|---|---|---|
| baseline | 50  | 2/3 | **1.17** | 1.46  | 2.94  |
| baseline | 100 | 0/3 | 3.94     | 5.10  | 6.55  |
| baseline | 200 | 0/3 | 13.37    | 13.55 | 14.12 |
| hybrid   | 50  | 1/3 | **1.13** | 2.12  | 3.79  |
| hybrid   | 100 | 0/3 | 5.61     | 6.05  | 7.94  |
| hybrid   | 200 | 0/3 | 12.88    | 16.09 | 15.32 |
| **pooled baseline** | | **2/9 (22.2 %)** | 1.17 | 6.19 | — |
| **pooled hybrid**   | | **1/9 (11.1 %)** | 1.13 | 8.12 | — |

Paired Δ:

| L | s | baseline | hybrid | Δ | winner |
|---|---|---|---|---|---|
| 50 | 0 | **1.456** ✓ | 8.118 | **+6.662** | baseline |
| 50 | 1 | 6.186 | 2.120 | −4.066 | hybrid (just over bar) |
| 50 | 2 | **1.173** ✓ | **1.128** ✓ | −0.044 | tie (both des.) |
| 100 | 0 | 5.097 | 6.048 | +0.950 | baseline |
| 100 | 1 | 10.613 | 5.612 | −5.000 | hybrid (both dead) |
| 100 | 2 | 3.942 | 12.169 | **+8.227** | baseline |
| 200 | 0 | 13.367 | 12.884 | −0.482 | hybrid (both dead) |
| 200 | 1 | 15.448 | 16.087 | +0.639 | baseline |
| 200 | 2 | 13.549 | 16.975 | +3.426 | baseline |
| **net** | | | | **mean Δ +1.146, median Δ +0.639** | **baseline 5 / hybrid 3 / ties 1** |

**Side-by-side (the anchor-fix axis):**

| metric | frozen_t05 | every_M=50 | Δ (every_M − frozen) |
|---|---|---|---|
| baseline pooled designability | 1/9 (11 %) | 2/9 (22 %) | +1 (ESMFold/MPNN noise across runs) |
| hybrid pooled designability | 1/9 (11 %) | 1/9 (11 %) | 0 |
| paired baseline wins | 7/9 | 5/9 | **−2** |
| paired hybrid wins | 2/9 | 3/9 | **+1** |
| paired ties | 0/9 | 1/9 | +1 |
| mean Δ (hybrid − baseline) | **+2.23 Å** | **+1.15 Å** | **−1.08 Å** |
| median Δ | +2.67 Å | +0.64 Å | −2.03 Å |

**Reading.** The anchor-mismatch fix moves the mean Δ ~1 Å in the right direction (frozen +2.23 → every_M +1.15) and reshuffles 2 baseline wins into 1 hybrid win + 1 tie, but does NOT flip the sign. Hybrid is still net WORSE than baseline under the cleaner anchor strategy.

**The most informative single observation is L=50/sample 0**, where the same noise seed produces:

| run | baseline | hybrid | Δ |
|---|---|---|---|
| frozen_t05 | 2.126 | 8.039 | +5.913 |
| every_M=50 | 1.456 ✓ | 8.118 | +6.662 |

The hybrid number is essentially invariant to anchor strategy (8.04 vs 8.12) — i.e., the K-set anchor matter is NOT what's driving the failure on this sample. And it is the sample where baseline is most clearly designable. Whatever is wrong, it's downstream of K-set selection.

**Mechanism story (consistent with F12 prediction).** §11's q/k/v projections, pair-bias entries, and the t-dependent curriculum K-mix `(32, 0, 0)` / `(16, 8, 24)` / `(8, 16, 32)` were calibrated during training for the specific K-set source (seq + spatial-1/d³ + random). At inference time, swapping in a *different* K-set — even a loss-aligned one drawn from dense's gradient saliency — is a distribution shift the trained weights have no calibration for. Sparse's downstream attention math doesn't "know" the K-set has changed; the q · k products and pair-bias additions are computed at the same magnitudes as before, but the meaning of "neighbor j" is now different. The result: a worse trajectory than even the content-free baseline K-set, because at least the baseline K-set is what the weights were trained against.

**This matches what F12 actually said.** F12 promoted "per-query routing distillation — training with the loss-aligned K-set" as the constructive next step, and explicitly noted that inference-only K-set swap is not the same experiment. E062 confirms the negative direction on the inference-only variant at N=3, on §11's trained weights. F12's narrow claim (per-query routing prior exists in dense, per-query gradient is a sharp/stable teacher signal) is unaffected by E062's result — F12 measured properties of the *teacher* (dense), not whether the *student* (sparse) can absorb them at inference time.

**Methodological caveats.**

- **N=3 per L.** Wilson 95 % CI on individual designability rates is wide (e.g. 1/9 = [0.6 %, 47 %]; 2/9 = [3 %, 60 %]). The 1-vs-2 designability difference between the two pooled baselines (across runs) is binomial noise + ESMFold/MPNN non-determinism. The paired Δ signal is the more robust read, since it controls for noise seed within each run.
- **ESMFold + ProteinMPNN are non-deterministic on this GPU**. Same baseline (sparse with default K-set) across the two strategy runs gave different per-sample scRMSDs (e.g. L=50 s=0 baseline: 2.13 in frozen, 1.46 in every_M; same seed, same code path). The within-run paired Δ is uncontaminated; the across-run comparison of *absolute* baseline numbers is. Direction of the across-run difference is plausibly random.
- **No designability re-baseline at §11 step 1800 N=9 outside this script** (the closest reference is [E051](#e051--n3-quick-designability-probe-of-ca_only_sparse_k64_curriculum_self-at-step-1800-2026-05-10) N=3 = 2/1/0 = 3/9 pooled at 33 %, vs E062's baseline 1/9 (frozen) and 2/9 (every_M)). The two E062 baseline pooled rates straddle E051's N=3 readout, which is consistent with binomial noise. Direction: every_M=50's baseline 2/9 is closer to E051's 3/9 than frozen_t05's 1/9 is.
- **The user's anchor-mismatch hypothesis was load-bearing for distinguishing the two failure modes** (anchor artifact vs F12-predicted trained-weights mismatch). Every_M=50 partially rules out the anchor artifact as the dominant issue: it moves mean Δ from +2.23 → +1.15, so anchor accounts for ~1 Å. The remaining ~+1.15 Å mean penalty + the persistent L=50/s=0 wreck point at the trained-weights-mismatch explanation.
- **Single sparse ckpt (§11 step 1800).** Whether E062's directional negative replicates on a different sparse trained ckpt — e.g. the sparse-K=40 variant ([E019](#e019--full-n30-fixed-mpnn-re-eval-of-e014-five-arms-2026-04-29) baseline, [E021](#e021--sparse-k40--pair-update-quick-n6-designability-probe-2026-04-30) + pair-update), or the BigBird-only [E058](#e058--cold-start-bigbird-only-no-pair-update-no-lowtsoft-on-the-11-trunk-2026-05-12-renumbered-from-upstream-e049-on-2026-05-13-merge) — is untested. The trained-weights-mismatch mechanism predicts the negative direction generalises (no sparse ckpt was trained against a content-aware K-set).
- **K=64 in the hybrid arm matches §11's training K=64.** If K were changed at inference (e.g. K=32), that would compound the distribution shift; the entry holds K constant to isolate the K-set *source* axis.
- **The cross-arm comparison is fair in seed but unfair in compute.** Hybrid does ~10 % more compute per protein at L=200 (the saliency backward + dense forward). If timing-budget were the metric, baseline already wins; designability is the right metric.
- **The "dense with attention restricted to top-K-by-gradient" experiment (the user's "what am I actually doing?" question) is NOT what E062 tests.** That experiment — dense's *velocities* but with attention sparsified per-query by gradient saliency — would isolate whether dense's weights can survive sparsification given its own routing prior. It is a different question and a different lever; not on the queue from this entry but flagged as a clean follow-up if the "sparse trained for gradient routing" experiment (the F12 main path) is judged too expensive.

**Possible narrative.** Non-narrative — kept for tuning/decision-making. **Decision the entry feeds: the F12 "per-query routing distillation" path requires training-with-routing-prior, not inference-only K-set swap.** E062 closes the cheap-to-test inference-only branch with a directional negative under two independent K-set strategies; the next experiment is the actual student training run that F12's "Constructive follow-ups" section anticipated (the per-query routing distillation training, not the K-as-function-of-N retraining, since K=64 is held fixed here).

**Cross-references.**

- Predecessor / source of the routing-prior hypothesis: [E061](#e061--per-query-vjp-gradient-saliency-inverts-e060-2026-05-13) (per-query VJP gradient saliency audit) and Finding 12 in `content_masterarbeit.md` (paper-facing claim).
- Baseline reference: [E051](#e051--n3-quick-designability-probe-of-ca_only_sparse_k64_curriculum_self-at-step-1800-2026-05-10) (§11 step 1800 N=3 = 3/9 pooled at 33 %); E046 (§11 step-1385 inference-only LOWTSOFT N=18 = 21/54 = 39 % pooled). E062's hybrid pool 1/9 = 11 % is below both, consistent with the trained-weights-mismatch mechanism story.
- Dense canonical reference: [E019](#e019--full-n30-fixed-mpnn-re-eval-of-e014-five-arms-2026-04-29) (76 % pooled N=30 at step 2646).
- Architectural framing: [E043](#e043--per-t-validation-loss-across-four-ca-only-architectural-variants-d1-of-the-hybrid-sampling-diagnostic-plan-2026-05-06--2026-05-07) (per-t val loss does not separate variants; F12 / E061 / E062 work at the per-(query, layer, head) level instead).
- Bug-fix patches in `script_utils/hybrid_grad_routing_inference.py` and `script_utils/eval_hybrid_grad_routing.py` are committed locally with this entry; not pushed to a separate PR.
- Output CSVs: `results/hybrid_grad_routing/grad_routing_smoke_n3/results_scrmsd.csv` (frozen_t05, 18 rows) and `results/hybrid_grad_routing/grad_routing_every_M50_n3/results_scrmsd.csv` (every_M=50, 18 rows).
- Output PDB dirs: `results/hybrid_grad_routing/{grad_routing_smoke_n3, grad_routing_every_M50_n3}/{baseline, hybrid}/L{50, 100, 200}/sample_{0, 1, 2}.pdb` (36 PDBs total).
- Logs: `nohup_hybrid_grad_routing_smoke.out`, `nohup_eval_hybrid_grad_routing.out`, `nohup_hybrid_grad_routing_everyM50.out`, `nohup_eval_everyM50.out`.
- Memory link: per [feedback_dead_arm_calls.md](../.claude/projects/-home-ks2218-la-proteina/memory/feedback_dead_arm_calls.md), this is NOT a dead-arm call on F12 — F12's narrow claim (per-query routing prior exists in dense) is undisturbed. E062 narrows F12's *constructive* implikation from "per-query routing distillation, possibly inference-only" to "per-query routing distillation, training-side only".

---

## E063 — Hybrid attn-routing inference-time test using dense attention at L1 H7 as routing teacher (2026-05-13)

**Status:** finished. Mixed result: directional positive on pooled designability + first paired hybrid designable that baseline missed, but net paired Δ still negative.

**Why ran:** [E062](#e062--hybrid-grad-routing-inference-time-test-of-the-per-query-routing-prior-on-11-sparse-step-1800-frozen_t05--every_m50-2026-05-13) was net-negative under gradient-routing. Two candidate explanations were live: **(a)** gradient saliency is the wrong routing signal (high gradient ≠ "should be in K-set" — could be loss-influence flowing through residual stream/FFN, not attention); **(b)** §11's trained weights can't tolerate ANY foreign K-set distribution without retraining, regardless of teacher. [E061](#e061--per-query-vjp-gradient-saliency-inverts-e060-2026-05-13)'s per-query cross-metric audit showed `max-over-(l, h) Jaccard(top-K_grad, top-K_attn) ∈ [0.74, 0.91]` and identified `(layer=1, head=7)` as the single cell with the highest agreement (18.3 % of queries' best-match). Substituting attention at L1 H7 for gradient saliency at the inference-time hybrid path tests (a) directly: if the attention-routed hybrid does meaningfully better than gradient-routed, (a) is real (gradient was wrong signal); if it does no better, (b) is dominant (no foreign K-set works on §11).

**Configs:**
- Script: `script_utils/hybrid_attn_routing_inference.py` (sibling of `hybrid_grad_routing_inference.py`; replaces `compute_gradient_K_set` with `compute_attention_K_set`, which runs ONE dense forward and monkey-patches `PairBiasAttention._attn` to capture the softmax pattern at the target (layer, head) and take top-K per query). No backward pass needed; ~200× cheaper per refresh than the gradient version.
- Sparse ckpt: `/rds/.../ca_only_sparse_K64_curriculum_self/1778188245/checkpoints/best_val_00000013_000000001385.ckpt` (raw, not EMA — same ckpt as [E062](#e062--hybrid-grad-routing-inference-time-test-of-the-per-query-routing-prior-on-11-sparse-step-1800-frozen_t05--every_m50-2026-05-13)).
- Dense ckpt: `test_ca_only_diffusion/1776805213/.../best_val_00000026_000000002646.ckpt` (canonical baseline).
- Target (layer, head) = **(1, 7)** — E061's top winner. `--target_layer 1 --target_head 7` (defaults in the script).
- Routing strategy: `every_M=50` (matches E062's better-anchored gradient run for paired comparison).
- N=3 per L ∈ {50, 100, 200}, seed=5 + protein_idx × 1000 + L (matches E062's seeding so noise pairs across runs at L=50 s=0 etc.).
- nsteps=400 (CLAUDE.md hard rule), full_simulation via `predict_for_sampling` + `sampling_model_args` (same path as E062, same B=2-pad workaround for the squeeze+assert bug at lines 626-632 of `product_space_flow_matcher.py`).
- Eval: `script_utils/eval_hybrid_grad_routing.py` (reused from E062; output: `results/hybrid_attn_routing/attn_routing_L1H7_every_M50_n3/results_scrmsd.csv`).

**Results — paired scRMSD per (L, sample):**

| L | s | baseline | hybrid (attn L1H7) | Δ (hybrid − baseline) | hybrid (grad every_M, E062) | hybrid (grad frozen, E062) | winner (this entry) |
|---|---|---:|---:|---:|---:|---:|---|
| 50  | 0 | **2.05** ✓ | 7.13 | **+5.08** | 8.12 | 8.04 | baseline (hybrid wreck, all 3 strategies) |
| 50  | 1 | 5.29 | 2.05 (just over bar) | −3.24 | 2.12 | 2.19 | hybrid (neither des.) |
| 50  | 2 | **0.88** ✓ | **1.58** ✓ | +0.70 | 1.13 ✓ | 1.64 ✓ | baseline (both des.) |
| 100 | 0 | 5.81 | **1.93** ✓ | **−3.88** | 6.05 | 9.62 | **hybrid designable; gradient missed it on the same seed** |
| 100 | 1 | 7.80 | 7.15 | −0.65 | 5.61 | 12.93 | hybrid (both dead) |
| 100 | 2 | 3.69 | 10.12 | +6.43 | 12.17 | 5.82 | baseline (both dead) |
| 200 | 0 | 10.93 | 17.03 | +6.10 | 12.88 | 16.58 | baseline (both dead) |
| 200 | 1 | 13.61 | 16.20 | +2.59 | 16.09 | 16.50 | baseline (both dead) |
| 200 | 2 | 12.69 | 14.95 | +2.26 | 16.97 | 15.59 | baseline (both dead) |
| **net** | | | | **mean Δ +1.71, median Δ +2.26** | (mean +1.15) | (mean +2.23) | **baseline 6 / hybrid 3 / ties 0** |

**Per-length aggregates:**

| arm | L | designable (<2 Å) | best Å | median Å | mean Å |
|---|---|---|---|---|---|
| baseline | 50  | 2/3 | 0.88 | 2.05 | 2.74 |
| baseline | 100 | 0/3 | 3.69 | 5.81 | 5.77 |
| baseline | 200 | 0/3 | 10.93 | 12.69 | 12.41 |
| hybrid   | 50  | 1/3 | 1.58 | 2.05 | 3.59 |
| hybrid   | 100 | 1/3 ← | 1.93 | 7.15 | 6.40 |
| hybrid   | 200 | 0/3 | 14.95 | 16.20 | 16.06 |
| **pooled baseline** | | **1/9 (11 %)** | 0.88 | 5.81 | — |
| **pooled hybrid**   | | **2/9 (22 %) ←** | 1.58 | 7.13 | — |

**Three-way side-by-side (this entry vs E062):**

| metric | E062 frozen_t05 grad | E062 every_M=50 grad | **E063 every_M=50 attn L1H7** |
|---|---|---|---|
| baseline pooled designability | 1/9 (11 %) | 2/9 (22 %) | 1/9 (11 %) |
| hybrid pooled designability   | 1/9 (11 %) | 1/9 (11 %) | **2/9 (22 %)** ← |
| paired baseline wins          | 7/9 | 5/9 | 6/9 |
| paired hybrid wins            | 2/9 | 3/9 | 3/9 |
| paired ties                   | 0   | 1   | 0   |
| mean Δ (hybrid − baseline) Å  | +2.23 | +1.15 | +1.71 |
| median Δ Å                    | +2.67 | +0.64 | +2.26 |

**Reading the (a) vs (b) decision tree.** Both branches are real, and they fire on different paired seeds:

- **Branch (a) — attention is a better teacher than gradient — confirmed at L=100 s=0.** Same noise seed: attn hybrid 1.93 Å ✓ designable, gradient hybrid 6.05 Å (every_M) / 9.62 Å (frozen) — both clearly dead. And the attention-routed hybrid clears the 2 Å designability bar where baseline (5.81 Å) doesn't. This is the **first paired sample across all three hybrid strategies where the hybrid arm produces a designable structure that the baseline misses**, and gradient missed it on the same noise too. The L1 H7 attention pattern carries routing information that gradient saliency at the same input does not — consistent with E061's per-query audit showing L1 H7 hits ≥ 13/16 overlap with gradient on average AND wins the "best-match" lottery for 18 % of queries.
- **Branch (b) — §11's weights can't absorb foreign K-set on some seeds — confirmed at L=50 s=0.** Same noise across all three strategies: attn 7.13, grad every_M 8.12, grad frozen 8.04 vs baseline 2.05/1.46. The hybrid scRMSD on this seed is *invariant to teacher signal and to anchor strategy* — moving the K-set source by an entirely different mechanism changes the hybrid scRMSD by less than 1 Å on a sample where baseline is solidly designable. Whatever is wrong with hybrid here is downstream of K-set selection; it's the trained-weights-mismatch story E062's narrative predicted, on at least this one paired seed.
- **Combined.** The per-query routing prior is real and capturable from dense — at least at L1 H7 in a way that gradient doesn't capture — but the inference-only swap is bottlenecked by train/inference mismatch on a non-trivial fraction of paired seeds, large enough to make the *aggregate* hybrid − baseline Δ net-positive (worse) even when individual designable wins exist.

**Methodological caveats:**

- **N=3 per L.** Wilson 95 % CI on 1/9 = [0.6, 47] %, on 2/9 = [3, 60] %. The 1-vs-2 pooled designability difference (baseline vs hybrid) is **inside binomial noise** — not yet evidence of a real pooled advantage. The paired-Δ aggregate (mean +1.71 Å, baseline 6/9 wins) is the stricter read; it remains net-negative.
- **ESMFold/MPNN non-determinism.** E062 noted the same baseline seed produces different scRMSDs across runs (e.g. E062 frozen baseline L=50/s=0 = 2.13, E062 every_M baseline L=50/s=0 = 1.46, E063 baseline L=50/s=0 = 2.05). Within-run paired Δ is uncontaminated; the *absolute* baseline number across runs is. Directionally the L=50 s=0 hybrid wrecks (7.13/8.04/8.12) are too far from the baseline range (1.46–2.13) for this noise to flip the conclusion.
- **Single (layer, head) tested.** L1 H7 is the global mode of E061's "best-match" distribution (18 %), but 82 % of queries are best-matched by some OTHER cell. A K-set computed from *per-query* best-(l, h) selection (rather than a fixed L1 H7) might give a sharper signal — but requires gradient computation to identify which (l, h) wins, defeating the cheap-attention advantage. L2 H4 (E061's #2 winner, 13.6 %) is the natural sibling check if you wanted a robustness probe; not run here.
- **K=64, matching §11's training.** Holding K constant isolates the K-set source axis. A simultaneous K change would compound the distribution shift.
- **Same §11 step-1800 ckpt as E062 baseline.** Whether the directional positive on pooled designability replicates on a different sparse ckpt is untested; the trained-weights-mismatch mechanism predicts the inference-only hybrid stays net-negative everywhere.
- **The "what fraction of paired seeds branch (a) vs (b)" question is N=3 here.** At L=100 s=0 (a) clearly wins; at L=50 s=0 (b) clearly wins; the other 7 samples are too dead-on-both-sides to attribute cleanly. A larger N (≥ 9 per L, say N=27 pooled) would let us estimate "fraction of seeds where attention-routing helps" vs "fraction where it can't escape (b)."

**Possible narrative.** Non-narrative — kept for tuning/decision-making. **Decision the entry feeds:** the F12 "per-query routing distillation" path's *constructive* version should use **dense attention at L1 H7** (or a learnable mixture of top-(l, h) cells, e.g. L1 H7 + L2 H4 + L0 H4 = 43 % of best-match queries) as the supervisory routing signal, not gradient saliency. The training-time argument: gradient saliency cost was the only reason it was a plausible cheap teacher (the audit *measured* it sharper than attention), but the inference-time test reverses this — attention is a strictly better routing signal in practice, and it's also cheaper at training time (one forward pass through dense per training step, no per-query backward). Branch (b)'s train/inference mismatch will still apply, which is precisely why the right experiment is training-side, not inference-only.

**Cross-references:**

- Predecessor (motivation for L1 H7 choice): [E061](#e061--per-query-vjp-gradient-saliency-inverts-e060-2026-05-13) per-query VJP cross-metric audit (best-match table: L1 H7 18.3 %, L2 H4 13.6 %, L0 H4 10.6 %).
- Predecessor (paired protocol): [E062](#e062--hybrid-grad-routing-inference-time-test-of-the-per-query-routing-prior-on-11-sparse-step-1800-frozen_t05--every_m50-2026-05-13) gradient-routing inference-time test.
- Same baseline reference as E062: [E051](#e051--n3-quick-designability-probe-of-ca_only_sparse_k64_curriculum_self-at-step-1800-2026-05-10) (§11 step 1800 N=3 = 3/9 = 33 %). E063 baseline 1/9 falls below E051's N=3 readout, inside binomial noise.
- Dense canonical reference: [E019](#e019--full-n30-fixed-mpnn-re-eval-of-e014-five-arms-2026-04-29) (76 % pooled N=30 at step 2646).
- Output CSV: `results/hybrid_attn_routing/attn_routing_L1H7_every_M50_n3/results_scrmsd.csv` (18 rows).
...
## E077 — First designability probe of the K=40 + curriculum + self cousin of §11 (`ca_only_sparse_K40_curriculum_self`, step 1133, 2026-05-23)

**Status:** finished. Pooled **2/18 (11.1 %)**; L=50 1/6, L=100 1/6, L=200 0/6. Below §11 K=64 step-944 ([E049](#e049--first-inference-probe-of-the-k64--curriculum-trained-ckpt-ca_only_sparse_k64_curriculum_self-ep9-step944-2026-05-08)) at L=50 (1 vs 3 designable) despite +189 training steps; matched at L=100 and L=200. Below the plain-K=40 baseline at step 1259 ([E044](#e044--inference-only-neighbor-list-curriculum-on-plain-sparse_k40-step-1259-2026-05-07), 5/18) by 3 designable. Verdict candidate: dead arm (curriculum's L=50 gain in §11 was K=64-budget-dependent, not curriculum-mechanism-dependent); awaiting user call.

**Why ran:** §11 K=64 + curriculum + self-inclusion bundles three architectural axes simultaneously. [E049](#e049--first-inference-probe-of-the-k64--curriculum-trained-ckpt-ca_only_sparse_k64_curriculum_self-ep9-step944-2026-05-08)'s headline finding ("L=50 retraining-validates E045: 3/6 designable, min 0.91 Å — the curriculum direction for short proteins is real and survives baked-in training") confounded the K=64-vs-K=40 budget axis with the curriculum axis. This probe is the K=40 cousin (same curriculum schedule scaled down: low (20,0,0) / mid (14,4,8) / high (8,8,16), all sum to K=40) — the cleanest available test of "is the L=50 win from curriculum, or from K=64 alone?". Feeds the decision of whether to keep the curriculum schema in the next-generation K=64 sparse trunk or strip it back to plain SALAD.

**Configs:**
- Ckpt: `/home/ks2218/la-proteina/best_val_00000011_000000001133.ckpt` (symlinked under canonical handle `sparse_K40_curriculum_self_step1133.ckpt`). Rsynced 2026-05-23 01:14 from `ks2218@login.hpc.cam.ac.uk:/rds/user/ks2218/hpc-work/store/ca_only_sparse_K40_curriculum_self/<RUN_ID>/checkpoints/`. Saved hyperparameters: `run_name_=ca_only_sparse_K40_curriculum_self`, `epoch=11`, `global_step=1133`, `nn.sparse_attention=True`, `nn.n_seq_neighbors=8`, `nn.n_spatial_neighbors=8`, `nn.n_random_neighbors=16` → K=40 static; `training.curriculum_neighbors=True`, `training.curriculum_low_t_split=[20,0,0]`, `training.curriculum_mid_t_split=[14,4,8]`, `training.curriculum_high_t_split=[8,8,16]` — all three buckets sum to K=40. `nn.update_pair_repr=False`, `nn.n_global_tokens` absent (no BigBird), `nn.token_dim=768`, 14 layers, 158,251,008 params, 454 state-dict tensors, 0 NaN-bearing tensors. state_dict sha256 prefix `2e55d43330994eac`.
- **Inference code patch required (this commit's working tree, not yet committed at run time):** the K=40-cousin training fork added `curriculum_mid_t_split` / `curriculum_high_t_split` keys under `cfg_exp.training` that the main-branch inference code didn't read, and `local_latents_transformer.py:260` hard-asserted `K == 64`. Patch (~10 lines):
  - `proteinfoundation/proteina.py:128-132`: extended `_sc_neighbors_kwargs` to forward `curriculum_mid_t_split` (default `(16,8,24)`) and `curriculum_high_t_split` (default `(8,16,32)`) from `cfg_exp.training` to `LocalLatentsTransformer`. Defaults preserve §11 / E055 / E056 K=64 behaviour.
  - `proteinfoundation/nn/local_latents_transformer.py:158-166`: added `self.curriculum_mid_t_split` and `self.curriculum_high_t_split` attributes (kwargs.get with K=64 defaults).
  - `proteinfoundation/nn/local_latents_transformer.py:260-290`: replaced hard `K == 64` assert with per-bucket consistency check (`2*n_seq_per_side + n_sp + n_rd == K` for each of low / mid / high splits, where K is the static-config-derived `2*n_seq + n_sp + n_rd`); used `self.curriculum_{low,mid,high}_t_split` in `buckets` list instead of hardcoded `(16,8,24)` / `(8,16,32)` constants; updated docstring to show both K=64 default schedule and K=40-cousin schedule.
  - Smoke-tested by running this entry's gen successfully (57.9 s, 18 PDBs at K=40-correct shape).
- Inference YAML: `configs/inference_sparse_K40_curriculum_self_step1133_n6_nfe400.yaml` (NEW; inherits `inference_base.yaml` → `nsteps=400`, `seed=5`). `nsamples=6`, `nres_lens=[50, 100, 200]`. No inference-time overrides on the NN block — K=40 + curriculum + self-inclusion all auto-replay from saved `cfg_exp` once the patched plumbing forwards the splits.
- Driver: `script_utils/probe_sparse_K40_curriculum_self_step1133.sh` (NEW; clone of `probe_sparse_K64_bigbird_lowtsoft.sh` with `CFG=inference_sparse_K40_curriculum_self_step1133_n6_nfe400`).
- Hardware: 1× L4 (GPU 4), `nohup`, sequential. **Wall: gen 57.9 s, eval 8m55s, total ~10 min.** Gen is unusually fast (~3.2 s/sample vs the canonical-eval reference's ~16 s/sample on L4) — K=40 sparse + compile + 14-layer 158M model + bf16 + all 18 samples fit one batch (max_nsamples_per_batch=6 × 3 lengths). Peak GPU 1.05 GB. Eval is the long phase as usual.
- Env: `/home/ks2218/.conda/envs/laproteina_env/bin/python` (canonical per CLAUDE.md).

**Results (per-sample best-of-{ca_esmfold, bb3o_esmfold} scRMSD, Å, sorted ascending; designable = `_res_scRMSD_ca_esmfold` < 2 Å):**

| L | s0 | s1 | s2 | s3 | s4 | s5 | designable | best | median |
|---|---|---|---|---|---|---|---|---|---|
| 50 | **1.08 ✓** | 2.48 | 3.34 | 3.47 | 8.65 | 9.34 | 1/6 | 1.08 | 3.40 |
| 100 | **1.66 ✓** | 3.51 | 7.06 | 7.67 | 9.65 | 16.27 | 1/6 | 1.66 | 7.37 |
| 200 | 8.12 | 12.52 | 12.73 | 15.25 | 15.57 | 16.18 | 0/6 | 8.12 | 13.99 |

CA-only scRMSD column (the formal designability metric):
- L=50: 1.08 ✓, 2.48, 3.38, 3.47, 8.75, 9.49
- L=100: 1.66 ✓, 3.57, 7.15, 7.67, 9.81, 16.42
- L=200: 8.12, 12.57, 12.86, 15.37, 15.70, 16.30

Per-sample best is invariant between ca_esmfold and bb3o_esmfold columns up to ~0.2 Å — the {ca / bb3o} backbone-source choice is not load-bearing here.

CSV: `inference/results_inference_sparse_K40_curriculum_self_step1133_n6_nfe400_0.csv`. Per-sample PDBs: `inference/inference_sparse_K40_curriculum_self_step1133_n6_nfe400/job_0_n_{L}_id_{i}/` (18 dirs).

**Cross-arm comparison at the closest matched cousins** (all N=6 × L∈{50,100,200} × nsteps=400 × seed=5):

| Arm | Step | L=50 (best Å) | L=100 (best Å) | L=200 (best Å) | Pooled | val/loss_epoch | notes |
|---|---|---|---|---|---|---|---|
| **K=40 + curriculum + self (E077, this)** | **1133** | **1/6 (1.08)** | **1/6 (1.66)** | **0/6 (8.12)** | **2/18 (11 %)** | not pulled | K=40-cousin schedule (20,0,0)/(14,4,8)/(8,8,16) |
| §11 K=64 + curriculum + self ([E049](#e049--first-inference-probe-of-the-k64--curriculum-trained-ckpt-ca_only_sparse_k64_curriculum_self-ep9-step944-2026-05-08)) | 944 | 3/6 (0.91) | 1/6 (1.22) | 0/6 (~12) | 4/18 (22 %) | 4.712 | K=64 canonical schedule (32,0,0)/(16,8,24)/(8,16,32) |
| §11 K=64 + curriculum + self ([E051](#e051--n3-quick-designability-probe-of-ca_only_sparse_k64_curriculum_self-at-step-1800-2026-05-10), N=3) | 1800 | 2/3 (0.89) | 1/3 (1.23) | 0/3 (~12) | 3/9 (33 %) | ~4.3 | same arm at canonical-window step |
| Plain K=40, no curriculum ([E044](#e044--inference-only-neighbor-list-curriculum-on-plain-sparse_k40-step-1259-2026-05-07) baseline) | 1259 | 3/6 | 1/6 | 1/6 | 5/18 (28 %) | — | the *unconfounded* K=40 reference |

Three converging lines that K=40 + curriculum + self is a regression vs the cousins:
1. **K=40 cousin underperforms §11 K=64 at L=50 by −2 designable (1 vs 3) and +0.17 Å on best-Å** despite +189 more training steps. Step delta cannot account for it: §11's own step 944 → 1800 (E049 → E051) trajectory shifts L=50 by 0/+1 designable, not by −2. Per memory `[Call dead experimental arms dead]`: step mismatch is *favourable* for K=40 here, so step is not a protective story.
2. **K=40 + curriculum (this) underperforms plain K=40 baseline at step 1259 by −3 designable pooled (2/18 vs 5/18).** Curriculum + self-inclusion bundled on K=40 is strictly worse than K=40 alone — the curriculum is not paying its training-axis cost at K=40. (Step 1133 vs 1259 = −126 steps; per E021 the plain-K=40 + pair-update arm hit its converged plateau at step 1133. K=40 + curriculum needs another ~125 steps to be at full convergence — but the headline gap is 3 designable, larger than the ~0.5 Å / 1 designable / 125 steps absorption envelope from prior matched-step swings.)
3. **The L=100 and L=200 numbers are flat-matched across K=40 / §11 K=64 at step 944**: the curriculum-on-§11's L=100 1/6 is reproduced by K=40 cousin's L=100 1/6, and L=200 0/6 is universal. So the K=64 advantage is L=50-specific. Since the curriculum's whole motivating story ([E045](#e045--t-dependent-k-budget-reallocation-curriculum-on-plain-sparse_k40-step-1259-2026-05-07), [E049](#e049--first-inference-probe-of-the-k64--curriculum-trained-ckpt-ca_only_sparse_k64_curriculum_self-ep9-step944-2026-05-08)) was the L=50 win, **and that win does not transfer when K is scaled down to 40, the curriculum mechanism on its own does not survive the K-budget ablation.** §11's L=50 number was (curriculum + K=64); the K=64 was load-bearing.

**Possible narrative:** non-narrative — feeds the architectural-axis decision for the next K=64 sparse trunk. The reading is *not* "curriculum is useless" (it might still help K=64 over plain K=64) but rather "if we strip the K=64 budget headroom, the curriculum doesn't recover it on its own". The cleanest next ablation if anyone wants to defend the curriculum mechanism is **plain K=64 no curriculum no self-inclusion at matched step**, which is also absent from the repo's run set — the §11 result has never been compared to a K=64 control. Until that comparison exists, the K=64-vs-curriculum disentangling is open in one direction (curriculum doesn't survive K=40-ablation) but not in the other (plain K=64 has never been measured).

**Methodological caveats:**
- N=6 × 3 lengths = 18 samples, single seed (=5). Wilson 95 % CI on 1/6 = [0.5 %, 64 %]; pooled 2/18 95 % CI = [1.4 %, 34 %]. The K=40-vs-K=64 L=50 gap (1/6 vs 3/6) is *not* nominally significant by Fisher's exact (p = 0.30); the dead-arm reading rests on (a) the converging-lines mechanism story above, (b) the additional plain-K=40-baseline anchor (5/18 → 2/18), and (c) the best-Å gap not just the count.
- **Step mismatch with cousins**: K=40 cousin is at step 1133 vs §11 step 944 (E049, +189 steps) and §11 step 1800 (E051, −667 steps); vs plain K=40 baseline at step 1259 (−126 steps). All step deltas are unfavourable for the K=40 cousin to lose (E044 was at MORE steps; E049 was at FEWER steps and STILL won at L=50). Per memory `[Call dead experimental arms dead]`: do not protect by step mismatch.
- **Inference-code patch is fresh in this session** (uncommitted at run time); behaviour was sanity-checked only by completing this gen and producing structurally non-degenerate PDBs at L=50 (best 1.08 Å — clearly not a wiring artifact). A regression-test against §11 K=64 step-944 with the patched code (which should reproduce E049 since the K=64 defaults match the previous hardcoded constants) was not run as part of this entry; the patch is logically a no-op for K=64 ckpts but that should be confirmed before treating future K=64-arm probes with this code as cross-comparable to pre-patch E049/E051/E055/E056 numbers.
- nsteps=400, seed=5, ProteinMPNN `ca_only=True`, ESMFold backbone reconstruction — standard CLAUDE.md eval protocol. nsteps confirmed via `inference_base.yaml` inheritance (no `generation.args.nsteps` override).
- val_loss for this run not yet pulled from wandb; the val-vs-designability cross-check ([feedback_wandb_val_loss_not_comparable](feedback_wandb_val_loss_not_comparable.md)) would require running `script_utils/run_per_t_val.py` paired with §11 — not done in this entry.
- The K=40 curriculum schedule `(20,0,0)/(14,4,8)/(8,8,16)` is a budget-scaled mirror of §11's `(32,0,0)/(16,8,24)/(8,16,32)`: low-t bucket is also fully sequential-only, mid bucket halves canonical's spatial+random ratio with the same balance, high bucket keeps SALAD canonical composition. The schedule's *shape* mirrors §11's; only the K-budget is halved. So the comparison is genuinely "K=40 vs K=64 on otherwise-matched schedules", not "different schedules at different K".

**Cross-references:**
- [E049](#e049--first-inference-probe-of-the-k64--curriculum-trained-ckpt-ca_only_sparse_k64_curriculum_self-ep9-step944-2026-05-08) — §11 K=64 step 944 (closest matched cousin; this entry's K=40 ablation isolates the K-budget axis).
- [E051](#e051--n3-quick-designability-probe-of-ca_only_sparse_k64_curriculum_self-at-step-1800-2026-05-10) — §11 K=64 step 1800 (in-canonical-window cousin; N=3 only).
- [E044](#e044--inference-only-neighbor-list-curriculum-on-plain-sparse_k40-step-1259-2026-05-07) — plain K=40 baseline at step 1259 (unconfounded K=40 reference for whether curriculum + self-inclusion at K=40 even matches K=40 alone — it does not).
- [E045](#e045--t-dependent-k-budget-reallocation-curriculum-on-plain-sparse_k40-step-1259-2026-05-07) — inference-only K=40 curriculum forcing (5/18 → 4/18; this entry's *trained-with-curriculum* K=40 is worse than the inference-only version, mirroring the §11 retraining-vs-inference-only pattern).
- [E055](#e055--first-designability-probe-of-the-five-axis-bundle-ca_only_sparse_k64_curriculum_self_bigbird_pairupdate_lowtsoft-step-944-2026-05-12) / [E056](#e056--first-designability-probe-of-the-four-axis-bundle-ca_only_sparse_k64_curriculum_self_bigbird-step-819-2026-05-13) — sibling K=64 + extra-axes probes (five- and four-axis bundles atop the §11 trunk; both came in below §11 itself, and the four-axis bundle was called dead).
- Memory: [[bigbird-globals-position-unaware]] (analogous "axis added on top of §11 doesn't help" pattern); [[dead-arm-calls]] (don't protect by step mismatch — applied above).

## E078 — Curriculum-OFF inference probe of the same K=40 curriculum+self ckpt (step 1133, 2026-05-23)

**Status:** finished. Pooled **6/18 (33 %)**; L=50 **5/6** (best 0.91), L=100 1/6 (best 1.66), L=200 0/6 (best 11.45). +4 designable swing at L=50 vs [E077](#e077--first-designability-probe-of-the-k40--curriculum--self-cousin-of-11-ca_only_sparse_k40_curriculum_self-step-1133-2026-05-23) (same ckpt, curric ON) on the same seed=5 paired protocol. Beats plain K=40 baseline ([E044](#e044--inference-only-neighbor-list-curriculum-on-plain-sparse_k40-step-1259-2026-05-07)) and §11 K=64 ([E049](#e049--first-inference-probe-of-the-k64--curriculum-trained-ckpt-ca_only_sparse_k64_curriculum_self-ep9-step944-2026-05-08)) at L=50.

**Why ran:** [E077](#e077--first-designability-probe-of-the-k40--curriculum--self-cousin-of-11-ca_only_sparse_k40_curriculum_self-step-1133-2026-05-23) read "K=40+curriculum+self is dead vs §11 K=64 at L=50 and vs plain K=40 at every length", framed as "K=64 budget was load-bearing for §11's L=50 win". The user asked to run the same ckpt with the trained-in curriculum forced OFF at inference (static K=40 (8,8,16) at all t) as the natural disambiguator: is the regression in E077 from (a) the K=40 architecture, (b) the curriculum-baked-in training schedule, or (c) the curriculum-at-inference path? E077 had collapsed all three; this entry isolates (c) by changing only the inference-time neighbor schedule on a paired-by-noise basis.

**Configs:**
- Ckpt: identical to E077 — `/home/ks2218/la-proteina/sparse_K40_curriculum_self_step1133.ckpt` → `best_val_00000011_000000001133.ckpt`, run `ca_only_sparse_K40_curriculum_self`, ep=11, step=1133, state_dict sha256 prefix `2e55d43330994eac`. Same plumbing patch applied to `proteinfoundation/proteina.py` + `local_latents_transformer.py` as in E077 (see E077 Configs section).
- Inference YAML: `configs/inference_sparse_K40_curriculum_self_step1133_NOCURRIC_n6_nfe400.yaml` (NEW). Sole delta vs the curric-ON config: adds `generation.args.curriculum_neighbors: false`. `nsteps=400` and `seed=5` inherited from `inference_base.yaml`. `nsamples=6`, `nres_lens=[50, 100, 200]`. Confirmed at runtime by gen-log line `2026-05-23 10:18:50 | INFO | generate.py:249 | [Curriculum neighbors] OFF — static neighbor split at all t (n_seq=8 per side, n_spatial=8, n_random=16).`
- Driver: `script_utils/probe_sparse_K40_curriculum_self_step1133_NOCURRIC.sh` (NEW; clone of the E077 driver with the `NOCURRIC` config name).
- Hardware: 1× L4 (GPU 4), `nohup`, sequential. **Wall: gen 58 s, eval 8m56s, total ~10 min** — matches E077's wall. Peak GPU ~1 GB. Code path: `generate.py:243-254` sets `model.nn.curriculum_neighbors = False` post-load; `LocalLatentsTransformer._build_neighbor_idx` then short-circuits to the static path at line 249-256 (no per-t bucketing).
...
| L | s0 | s1 | s2 | s3 | s4 | s5 | designable | best | median |
|---|---|---|---|---|---|---|---|---|---|
| 50 | **0.91 ✓** | **0.96 ✓** | **1.53 ✓** | **1.65 ✓** | **1.97 ✓** | 2.99 | **5/6** | 0.91 | 1.59 |
| 100 | **1.66 ✓** | 2.53 | 7.35 | 7.54 | 9.42 | 9.61 | 1/6 | 1.66 | 7.45 |
| 200 | 11.45 | 11.95 | 14.41 | 14.47 | 14.54 | 17.62 | 0/6 | 11.45 | 14.44 |

CA-only scRMSD column (formal designability metric, designable threshold = 2.0 Å):
- L=50: 0.91 ✓, 0.96 ✓, 1.53 ✓, 1.65 ✓, 1.97 ✓, 2.99 → **5/6 designable**
- L=100: 1.66 ✓, 2.53, 7.45, 7.77, 9.42, 9.62 → 1/6
- L=200: 11.57, 12.07, 14.41, 14.49, 14.57, 17.73 → 0/6

CSV: `inference/results_inference_sparse_K40_curriculum_self_step1133_NOCURRIC_n6_nfe400_0.csv`.

**Paired-by-noise comparison vs E077 (same seed=5, same ckpt, same lengths, same nsteps; only the inference-time curriculum flag differs):**

| L | seed-slot | E077 ca-scRMSD (curric ON) | E078 ca-scRMSD (curric OFF) | Δ (OFF − ON) | OFF designable? |
|---|---|---|---|---|---|
| 50 | 0 | 1.08 ✓ | 1.97 ✓ | +0.89 | ✓ |
| 50 | 1 | 2.48 | 0.96 ✓ | **−1.52** | ✓ |
| 50 | 2 | 3.38 | 1.65 ✓ | **−1.73** | ✓ |
| 50 | 3 | 3.47 | 0.91 ✓ | **−2.56** | ✓ |
| 50 | 4 | 8.75 | 1.53 ✓ | **−7.22** | ✓ |
| 50 | 5 | 9.49 | 2.99 | **−6.50** | ✗ (but 6.5 Å closer) |
| 100 | 0 | 1.66 ✓ | 1.66 ✓ | 0.00 | ✓ |
| 100 | 1 | 3.57 | 2.53 | −1.04 | ✗ |
| 100 | 2 | 7.15 | 7.45 | +0.30 | ✗ |
| 100 | 3 | 7.67 | 7.77 | +0.10 | ✗ |
| 100 | 4 | 9.81 | 9.42 | −0.39 | ✗ |
| 100 | 5 | 16.42 | 9.62 | **−6.80** | ✗ (but 6.8 Å closer) |
| 200 | 0 | 8.12 | 11.57 | +3.45 | ✗ |
| 200 | 1 | 12.57 | 12.07 | −0.50 | ✗ |
| 200 | 2 | 12.86 | 14.41 | +1.55 | ✗ |
| 200 | 3 | 15.37 | 14.49 | −0.88 | ✗ |
| 200 | 4 | 15.70 | 14.57 | −1.13 | ✗ |
| 200 | 5 | 16.30 | 17.73 | +1.43 | ✗ |

Mean Δ per length (curric OFF − curric ON; negative = curric-OFF wins):
- L=50: **−3.11 Å** (curric-OFF dominates; +4 designable, every paired sample either becomes designable or gets ≥ 6 Å closer).
- L=100: −1.31 Å (curric-OFF wins one collapsed sample by 6.8 Å; rest tied).
- L=200: +0.65 Å (curric-OFF slightly worse but both arms dead).
- Pooled: **−1.26 Å mean paired Δ favouring curric-OFF**.

The L=50 swing is the largest and the only one that crosses the designability threshold. Three out of six paired samples flip from non-designable (curric ON) to designable (curric OFF) with curric-OFF improvements of −1.73 / −2.56 / −7.22 Å; one slot (#4) goes from 8.75 Å (curric ON, broken) to 1.53 Å (curric OFF, designable) — a 7.2 Å improvement on the same noise. The reverse is rare and small: slot #0 at L=50 worsens by +0.89 Å (still designable in both arms); slot #2 at L=200 worsens by +1.55 Å (both dead).

**Cross-arm comparison at the closest matched cousins** (all N=6 × L∈{50,100,200} × nsteps=400 × seed=5):

| Arm | Step | L=50 | L=100 | L=200 | Pooled | notes |
|---|---|---|---|---|---|---|
| **K=40+curric+self ckpt, curric OFF (E078, this)** | **1133** | **5/6 (0.91)** | **1/6 (1.66)** | **0/6 (11.45)** | **6/18 (33 %)** | trained-in curriculum forced off at inference |
| K=40+curric+self ckpt, curric ON ([E077](#e077--first-designability-probe-of-the-k40--curriculum--self-cousin-of-11-ca_only_sparse_k40_curriculum_self-step-1133-2026-05-23)) | 1133 | 1/6 (1.08) | 1/6 (1.66) | 0/6 (8.12) | 2/18 (11 %) | same ckpt, trained-distribution inference |
| §11 K=64+curric+self ([E049](#e049--first-inference-probe-of-the-k64--curriculum-trained-ckpt-ca_only_sparse_k64_curriculum_self-ep9-step944-2026-05-08)) | 944 | 3/6 (0.91) | 1/6 (1.22) | 0/6 | 4/18 (22 %) | matched-architecture-axes K=64 cousin, curric ON |
| §11 K=64+curric+self ([E051](#e051--n3-quick-designability-probe-of-ca_only_sparse_k64_curriculum_self-at-step-1800-2026-05-10), N=3) | 1800 | 2/3 (0.89) | 1/3 (1.23) | 0/3 | 3/9 (33 %) | §11 at canonical-window step |
| plain K=40, no curric ([E044](#e044--inference-only-neighbor-list-curriculum-on-plain-sparse_k40-step-1259-2026-05-07)) | 1259 | 3/6 | 1/6 | 1/6 | 5/18 (28 %) | unconfounded K=40 reference (no curriculum in training) |

**E078 at L=50 (5/6, best 0.91) beats every other K=40-class run on record AND matches §11 K=64 step-1800's best-Å (0.89).** L=100 / L=200 are flat across all K-class arms — the L=50 axis is where the curriculum-at-inference path was costing this ckpt designable samples.

**Reframing E077:**
1. E077's "K=40+curriculum+self regresses vs §11 K=64" reading was correct under the curric-ON inference path it used, but **the cause was the inference path, not the architecture or training**.
2. The "K=64 budget was load-bearing for §11's L=50 win" hypothesis is **not supported** by this entry: K=40+curric+self with curric-OFF inference matches §11 K=64+curric+self with curric-ON inference at L=50 (5/6 vs 3/6 — better, even). If K=64 were load-bearing, no inference-path change should close that gap.
3. The actually-supported claim now is: **the curriculum-at-inference path on this K=40 ckpt is worse than the static-K=40 path on the same ckpt by +4 designable at L=50 (paired)**. Whether the K=64 §11 ckpt also pays a curriculum-at-inference cost remains open — the analogous curric-OFF probe on §11 has never been run.

**Mechanism candidates (untested by this entry):**
- **Asymmetric generalization**: the trained model can use richer-than-training inputs (8,8,16) at low t even though it only saw (20,0,0) sequential-only at low t during training. Spatial+random capacity at low t buys the model real signal that the training schedule denied it.
- **Training-data low-t noise floor**: at t<0.33 the data is mostly noise; (20,0,0) sequential-only training meant the model could not use spatial structure to fight that noise. At inference time, spatial+random pointers to the *current* CA estimate provide useful denoising signal even though the model was never trained against this distribution.
- **q/k/v projections trained on a richer mid-bucket (14,4,8) generalize to plain (8,8,16) easily** because (8,8,16) is closer to (14,4,8) than (20,0,0) is to (8,8,16) in any sensible neighbor-composition metric.

The §11 K=64 analogue of this asymmetry is the obvious next probe (§11 K=64 + curric+self + curric-OFF inference); if §11 ALSO improves by curric-OFF inference, the curriculum mechanism is broadly costing designability at inference across both K-budgets. If §11 does NOT improve, the asymmetry is K=40-specific (possibly because K=40 mid (14,4,8) is closer to static (8,8,16) than K=64 mid (16,8,24) is to static (8,16,32)).

**Possible narrative:** non-narrative as a single entry — but the paired curric-ON-vs-curric-OFF picture on the same ckpt is *finding-grade* if it replicates at higher N, on §11, and ideally at multiple steps. The narrow claim "trained-in curriculum hurts this ckpt at inference time" is defensible from this paired N=6 data; the broader "curriculum mechanism does not transfer to inference for sparse trunks" needs the §11 analogue + ideally a couple of seeds. Feeds the routing-distillation decision: if static-K inference works better than the trained schedule, the schedule was not load-bearing for the learned representation, which weakens the "we must train sparse with attention/grad routing as supervisory signal" branch from [E062](#e062--hybrid-grad-routing-inference-time-test-of-the-per-query-routing-prior-on-11-sparse-step-1800-frozen_t05--every_m50-2026-05-13) / [E063](#e063--hybrid-attn-routing-inference-time-test-using-dense-attention-at-l1-h7-as-routing-teacher-2026-05-13) (Finding 12).

**Methodological caveats:**
- **N=6 single-seed, paired with E077 by noise seed only** — the +4-designable swing at L=50 is large in absolute terms but Fisher's exact on 5/6 vs 1/6 paired (McNemar's test, b=4 discordant pairs all favouring curric-OFF, c=0): exact binomial p = 2 × (0.5)^4 = 0.125. With 4 of 4 discordant pairs in the same direction the swing is *directionally* robust but doesn't clear nominal significance at N=6.
- **Distribution-shift caveat (per `generate.py:246-247` and the YAML header)**: the model was trained against the curriculum schedule, so feeding it plain (8,8,16) at low t is a foreign input distribution. The fact that this *improves* designability rather than hurts it is the surprising finding; the conventional expectation would have been a regression. The result is not a clean architectural test — curric-OFF is "what would the trained weights do if you swapped them onto a different inference path" — but for the question being asked ("which inference path produces designable samples on this ckpt") it is exactly the right protocol.
- **No §11 K=64 curric-OFF control** — the §11 cousin numbers in the cross-arm table are all curric-ON; the curric-ON-vs-curric-OFF gap may or may not exist for K=64 ckpts. This is the highest-priority follow-up probe.
- **L=100 / L=200 unchanged within noise**: the curriculum-at-inference effect is L=50-localized in this probe. Whether that holds at higher L (this run only covers L ∈ {50, 100, 200}) is untested.
- nsteps=400, seed=5, ProteinMPNN `ca_only=True`, ESMFold backbone reconstruction — standard CLAUDE.md eval protocol.

**Cross-references:**
- [E077](#e077--first-designability-probe-of-the-k40--curriculum--self-cousin-of-11-ca_only_sparse_k40_curriculum_self-step-1133-2026-05-23) — direct parent; this entry supersedes its architecture verdict.
- [E049](#e049--first-inference-probe-of-the-k64--curriculum-trained-ckpt-ca_only_sparse_k64_curriculum_self-ep9-step944-2026-05-08) — §11 K=64 step 944 (the matched-architecture-axes cousin that E077 used as the "loses to" reference; E078 ties/beats it at L=50).
- [E051](#e051--n3-quick-designability-probe-of-ca_only_sparse_k64_curriculum_self-at-step-1800-2026-05-10) — §11 K=64 step 1800 (the canonical-window cousin; matches E078's L=50 best-Å within ~0.02 Å).
- [E044](#e044--inference-only-neighbor-list-curriculum-on-plain-sparse_k40-step-1259-2026-05-07) — plain K=40 baseline at step 1259 (the K-controlled reference; E078 beats it at L=50 despite +126 step deficit).
- [E045](#e045--t-dependent-k-budget-reallocation-curriculum-on-plain-sparse_k40-step-1259-2026-05-07) — inference-only K=40 curriculum forcing on the no-curric ckpt (the *opposite* direction of this entry's effect: forcing curriculum at inference on a no-curric-trained model hurt L=50; forcing no-curriculum at inference on a curric-trained model helps L=50; both consistent with "static (8,8,16) is the better inference path regardless of training schedule").
- [E062](#e062--hybrid-grad-routing-inference-time-test-of-the-per-query-routing-prior-on-11-sparse-step-1800-frozen_t05--every_m50-2026-05-13) / [E063](#e063--hybrid-attn-routing-inference-time-test-using-dense-attention-at-l1-h7-as-routing-teacher-2026-05-13) — earlier "inference-only K-set swap on §11's trained weights is net negative" probes. This entry's "inference-only schedule swap on K=40 trained weights is net positive" is the opposite-sign finding on a different sparse trunk; the cleanest reconciliation is "static (8,8,16) is closer to the K=40 training distribution than gradient/attention-derived K-sets are to the §11 K=64 training distribution".
- Memory: [[dead-arm-calls]] (E077's framing-as-dead retracted on the architecture axis); no relevant existing memory for "trained-in schedule vs inference-time schedule asymmetry" — candidate new memory if this replicates on §11.

**Action items (untaken in this entry):**
- Run §11 K=64 step 1800 curric-OFF inference (same protocol) — single GPU-hour test of whether the asymmetry generalizes to K=64.
- Run E078 at multiple seeds (≥ 3 seeds × N=6) to put a confidence interval on the +4-designable L=50 swing.
- Run E078 at L ∈ {300, 400, 500} (or wherever the production regime is) to check whether the curriculum-at-inference cost holds outside the small-L window.

---

## E079 — N=24 extension of E078: curriculum-OFF inference on K=40+curric+self ckpt step 1133 (2026-05-23)

**Status:** finished. Pooled **11/72 (15.3 %)**; L=50 **10/24 (41.7 %, best 0.73 Å)**, L=100 1/24 (4.2 %, best 1.66 Å), L=200 0/24 (0 %, best 8.31 Å). **Softens E078's small-N headline substantially** — the +4-designable L=50 swing E078 reported (5/6 = 83 %) was a small-N upper draw; the converged-N rate on this ckpt + this inference protocol is **42 % at L=50**, not 83 %.

**Why ran.** [E078](#e078--curriculum-off-inference-probe-of-the-same-k40-curriculum-self-ckpt-step-1133-2026-05-23) at N=6 reported a +4-designable L=50 swing vs E077's curric-ON arm and an 83 % L=50 rate (5/6) — by far the highest L=50 number on any K=40-class arm on record. The N=6 95 % Wilson CI on 5/6 is [36, 99] %, wide enough that the headline was load-bearing on a small handful of paired noise samples. User asked to add 18 more samples per length (N=24 total) on the same ckpt + same seed=5 + same configs, to tighten the CI before committing to E078's "curric-OFF inference outperforms plain K=40 baseline" narrative. Curric-ON arm extension (planned as a sibling N=24 of E077) was started in parallel but cancelled per user direction; only the curric-OFF arm is in this entry.

**Configs:**
- Inference YAML: `configs/inference_sparse_K40_curriculum_self_step1133_NOCURRIC_n24_nfe400.yaml` (NEW). Sole delta vs E078's YAML: `generation.dataset.nsamples=24` (was 6). Same `max_nsamples_per_batch=6` → 4 batches per L. `seed=5` and `nsteps=400` inherited from `inference_base.yaml`. `curriculum_neighbors: false` under `generation.args` — static K=40 split (n_seq=8 per side, n_spatial=8, n_random=16) at all t.
- Driver: `script_utils/probe_sparse_K40_curriculum_self_step1133_NOCURRIC_n24.sh` (NEW; clone of E078's driver with the new `CFG=` name).
- Checkpoint: `/home/ks2218/la-proteina/sparse_K40_curriculum_self_step1133.ckpt` → `best_val_00000011_000000001133.ckpt` (same symlink as E077/E078). `run_name_=ca_only_sparse_K40_curriculum_self`, `global_step=1133`.
- Hardware: 1× NVIDIA L4 (GPU 3), nohup. **Wall: gen 4m30s, eval 33m54s, total ≈ 38 min.** Eval scales ~4× from E078 N=6 (~9 min eval) as expected for 4× more PDBs.
- Output: `inference/inference_sparse_K40_curriculum_self_step1133_NOCURRIC_n24_nfe400/` (72 PDBs across 12 length-id batches). CSV: `inference/results_inference_sparse_K40_curriculum_self_step1133_NOCURRIC_n24_nfe400_0.csv`. Logs at `nohup_inference_sparse_K40_curriculum_self_step1133_NOCURRIC_n24_nfe400.{gen,eval}.log`.
- Runtime hook confirmation (gen log line 2): `[Curriculum neighbors] OFF — static neighbor split at all t (n_seq=8 per side, n_spatial=8, n_random=16).`

**Results — per-L designability (`_res_scRMSD_ca_esmfold < 2 Å`):**

| L | N | designable | best (Å) | median | worst | sorted scRMSD (Å) |
|---|---|---|---|---|---|---|
| 50  | 24 | **10/24 (41.7 %)** | **0.73** | 2.32  | 14.73 | 0.73, 0.78, 0.85, 0.94, 0.95, 1.14, 1.19, 1.87, 1.97, 1.98, 2.06, 2.17, 2.32, 2.50, 2.75, 3.03, 3.42, 4.38, 4.47, 4.66, 4.82, 8.00, 11.25, 14.73 |
| 100 | 24 | 1/24 (4.2 %)   | 1.66    | 5.35  | 11.92 | 1.66, 2.21, 2.37, 2.51, 2.68, 2.69, 2.89, 3.15, 3.95, 3.99, 4.13, 4.95, 5.35, 5.85, 7.81, 8.79, 9.04, 9.36, 9.39, 9.42, 10.06, 10.31, 10.78, 11.92 |
| 200 | 24 | 0/24 (0 %)     | 8.31    | 12.37 | 17.00 | 8.31, 8.89, 9.26, 9.40, 9.84, 10.26, 10.45, 10.78, 11.02, 11.18, 11.67, 11.68, 12.37, 12.59, 12.84, 13.49, 13.73, 13.96, 14.85, 14.99, 15.49, 15.56, 16.26, 17.00 |
| **pooled** | 72 | **11/72 (15.3 %)** | **0.73** | — | — | — |

Headline (printed by `evaluate.py`): "Average scRMSD: 7.279 Å, Success Rate (<2Å): 15.3 %, Total: 72, Failed: 0".

**E079 is NOT paired-by-noise with E078.** Increasing `nsamples` from 6 → 24 shifts the upstream RNG consumption pattern; the first 6 samples in E079 differ from E078 element-wise:

| L | E078 batch-0 (N=6) | E079 first 6 |
|---|---|---|
| 50  | 1.53, 1.65, 0.96, 0.91, 2.99, 1.97 | 1.98, 0.73, 4.47, 11.25, 0.85, 0.95 |
| 100 | 7.45, 1.66, 9.62, 2.53, 9.42, 7.77 | 9.42, 1.66, 2.69, 10.06, 7.81, 11.92 |
| 200 | 14.41, 12.07, 14.57, 17.73, 11.58, 14.49 | 11.18, 10.26, 16.26, 9.26, 15.49, 14.99 |

So E079 is an **independent N=24 draw** at seed=5, not a paired extension. The L=100 sample at scRMSD 1.66 appearing in both is by coincidence of the model producing a near-identical structure for a numerically different noise input; the rest of the rows differ throughout. The right way to use E078 + E079 together is "two independent reads at seed=5 on the same ckpt, n_total=30 if pooled".

**Cross-arm comparison at canonical N=6/24 (all paired protocol — same seed=5, nsteps=400, ckpt step where relevant):**

| Arm | Step | N | L=50 | L=100 | L=200 | Pooled | Source |
|---|---|---|---|---|---|---|---|
| Dense canonical (reference) | 2646 | 30 | 26/30 (87 %) | 26/30 (87 %) | 16/30 (53 %) | 68/90 (76 %) | [E019](#e019--full-n30-fixed-mpnn-re-eval-of-e014s-four-arms--5th-paramgroups-arm-2026-04-29) |
| Plain K=40 (no curric) | 1259 | 30 | 13/30 (43 %) | 8/30 (27 %) | 0/30 | 21/90 (23 %) | [E019](#e019--full-n30-fixed-mpnn-re-eval-of-e014s-four-arms--5th-paramgroups-arm-2026-04-29) |
| Plain K=40 (no curric) — N=6 cousin | 1259 | 6 | 2/6 (33 %) | 3/6 (50 %) | 0/6 | 5/18 (28 %) | [E044](#e044--inference-only-neighbor-list-curriculum-on-plain-sparse_k40-step-1259-2026-05-07) baseline |
| K=40 + curric + self, curric ON | 1133 | 6 | 1/6 (17 %) | 1/6 (17 %) | 0/6 | 2/18 (11 %) | [E077](#e077--first-designability-probe-of-the-k40--curriculum--self-cousin-of-11-ca_only_sparse_k40_curriculum_self-step-1133-2026-05-23) |
| K=40 + curric + self, curric OFF | 1133 | 6 | 5/6 (83 %, best 0.91) | 1/6 (17 %, best 1.66) | 0/6 | 6/18 (33 %) | [E078](#e078--curriculum-off-inference-probe-of-the-same-k40-curriculum-self-ckpt-step-1133-2026-05-23) ⚠ small-N upper draw |
| **K=40 + curric + self, curric OFF (E079 this)** | **1133** | **24** | **10/24 (42 %, best 0.73)** | **1/24 (4 %, best 1.66)** | **0/24 (0 %)** | **11/72 (15 %)** | converged-N read |

**Findings:**

1. **E078's "83 % at L=50, curric-OFF beats plain K=40" headline is largely a small-N upper draw.** At N=24 the L=50 rate drops to 42 % — within the Wilson 95 % CI of E078's 83 % (CI was [36, 99] %), but well below the 50–83 % range that the E078 entry's claims were anchored on. The curric-OFF arm at this ckpt is **at the same level as plain K=40** at L=50 (42 % vs E019's 43 % at N=30, vs E044's 33 % at N=6), not above it.
2. **The L=100 picture is worse than E078 suggested.** E078 reported 1/6 (17 %) at L=100; E079 reports 1/24 (4 %). The single L=100 designable sample (best 1.66 Å) shows up in both runs as the only L=100 hit, suggesting this ckpt produces ~1 designable L=100 structure per ~24 draws. E044 plain-K=40 baseline at step 1259 produced 3/6 (50 %) at L=100; E019's full-N had 8/30 (27 %). At 1/24 = 4 %, **curric-OFF inference on the K=40 + curric + self ckpt is worse than plain K=40 at L=100, not equal-or-better.**
3. **L=200 cliff intact.** 0/24 with best 8.31 Å. The longer-protein cliff that has shown up in every sparse arm at this training stage is reproduced; min Å at L=200 is consistent with E078's 11.45 Å (cleaner draw here).
4. **The best L=50 single-protein scRMSD is 0.73 Å — best of any K=40-class arm on record** (vs E078's 0.91, E044's plain-K=40 best 0.97). The ceiling of what this ckpt can do at L=50 is real and competitive; the *rate* is the problem.
5. **The "trained-in curriculum hurts at inference" mechanism (E078) survives qualitatively but with a much smaller magnitude.** Pooling E078 + E079 as two independent reads at seed=5 → 15/90 designable on the curric-OFF arm vs E077's 2/18 (11 %) on curric-ON. The asymmetry is still in the same direction (curric-OFF > curric-ON), but the *production-relevant* claim — "this trained-with-curriculum ckpt with curric-OFF at inference beats plain K=40 baseline" — does NOT survive: 15 % pooled vs E019's 23 % at N=30, vs E044's 28 % at N=6.
6. **Verdict update on the K=40 + curric + self arm:** the architecture is *not* outperforming plain K=40. E078's "architecture is not dead, only the inference path is dead" framing — which itself superseded E077's "architecture is dead" framing — needs to be softened to "architecture is at or below plain K=40 even with the best available inference path; training-time curriculum on K=40 is a wash at best, and possibly a small negative".

**Possible narrative.** Non-narrative as a single entry, but **methodologically Finding-grade in combination with E077/E078**: a three-entry sequence on the same ckpt where the apparent verdict flipped twice (dead → alive → at-baseline) tracks small-N draws moving inside the binomial CI. Worth a methodological note in `content_masterarbeit.md` if the sparse-variant section discusses the cost of single-seed N=6 probes for architectural decision-making. The narrow claim — "the K=40 + curriculum + self-inclusion trained ckpt at step 1133, evaluated with curriculum disabled at inference, achieves ~42 % designability at L=50, ~4 % at L=100, 0 % at L=200 (N=24, seed=5)" — is defensible. The broader "curriculum at inference is the problem" claim from E078 is weaker than that entry suggested; what E079 shows is that the curric-ON arm is unambiguously worse (E077), but the curric-OFF arm only matches plain K=40 at L=50, not beats it.

**Methodological caveats:**
- **N=24 single seed (seed=5).** Wilson 95 % CI: 10/24 = [22, 63] %. The conclusion "curric-OFF rate at L=50 is ~42 %" should be read as "in the [22, 63] % band"; the conclusion "curric-OFF is below plain K=40 at L=50" requires a multi-seed N=30 to be tightened (currently both rates sit inside each other's CI).
- **Not paired-by-noise with E078** (table above). The two runs cannot be slot-matched; treat as two independent reads. Pooling N=6 + N=24 = 30 is informationally fine if the assumption is "same ckpt produces the same population of outputs at seed=5"; this is true for the ckpt + the model code, but the noise distribution is technically different per `nsamples`.
- **`nsteps=400`** ✓ (HARD RULE; inherited from `inference_base.yaml`).
- **`generation.args.curriculum_neighbors: false`** ✓ (confirmed in gen-log line 2 via the post-load hook in `generate.py:243-254`).
- **No paired curric-ON N=24 cousin** — the planned sibling probe (E079's curric-ON twin) was launched on GPU 0 and killed at user request after ~4 min of gen, before any results were produced. If the curric-ON arm's rate also rises under N=24 in a similar magnitude, the curric-ON-vs-curric-OFF gap (currently 11 % vs 15 %) would tighten further. The +4-designable L=50 swing E078 documented may not survive at N=24; this is the largest open question on this ckpt family and would need a fresh sibling probe to close.
- **L=200 = 0/24** is well-bounded (Wilson 95 % CI [0, 14 %]); the L=200 cliff is not an under-N artifact.
- **Production-relevant baseline (plain K=40 N=6 at step 1259, [E044](#e044--inference-only-neighbor-list-curriculum-on-plain-sparse_k40-step-1259-2026-05-07)) used a different step** (1259 vs 1133, +126 step deficit for the curric ckpt). The cross-arm comparison is not perfectly step-matched; a curric-ON-or-OFF probe at step ≥ 1259 would close that gap. Direction of bias is unfavourable to curric-OFF (curric ckpt is at fewer steps), so the under-performance result is robust to step-matching.

**Cross-references:**
- Direct predecessor: [E078](#e078--curriculum-off-inference-probe-of-the-same-k40-curriculum-self-ckpt-step-1133-2026-05-23) (N=6 small-N read; E079 sharpens it).
- Curric-ON cousin (unchanged): [E077](#e077--first-designability-probe-of-the-k40--curriculum--self-cousin-of-11-ca_only_sparse_k40_curriculum_self-step-1133-2026-05-23) (N=6, 2/18 = 11 %).
- Plain K=40 baseline: [E019](#e019--full-n30-fixed-mpnn-re-eval-of-e014s-four-arms--5th-paramgroups-arm-2026-04-29) (N=30) and [E044](#e044--inference-only-neighbor-list-curriculum-on-plain-sparse_k40-step-1259-2026-05-07) (N=6) at step 1259 — E079 is at or below both.
- Memory updates pending: [[feedback_steering_use_codesignability]]-style "small-N draws can move verdict twice" caveat is reinforced; the candidate "trained-in vs inference-time schedule asymmetry" memory mentioned at E078's bottom should *not* be written yet — the asymmetry survives but its magnitude is much smaller than E078 framed.

**Action items (untaken in this entry):**
- Repeat the paired-by-noise curric-ON N=24 probe (was killed after launch) to confirm whether the curric-OFF advantage at L=50 holds at converged N or vanishes.
- Multi-seed (≥ 3 seeds × N=12) to put a defensible CI on the 42 % L=50 rate.
- §11 K=64 step 1800 curric-OFF inference at N=24 (the same generalization test E078 flagged) — now with the N=24 protocol locked.
