# P44_v1: Steering codesign-vs-property Pareto frontiers, three properties in one
#   row (hydrophobic patch | CamSol | TANGO), shared codesign axis + one legend.
#   VERSION v1 = WITHOUT error bands (clean means). See P44_v2 for the +/-1 SEM version.
...
SHOW_SEM = False                          # <-- the only difference vs P44_v2
